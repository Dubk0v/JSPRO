...
class Hamburger {
    ...
    static buttonCalculate() {
        ...
        console.log(`Cost of your hamburger ${burger.calculatePrice()} rub`);
        console.log(`In your hamburger ${burger.calculateCalories()} calories`);
        document.getElementById("text").innerHTML = `Cost of your hamburger ${burger.calculatePrice()} rub, In your hamburger ${burger.calculateCalories()} calories`;
    }
